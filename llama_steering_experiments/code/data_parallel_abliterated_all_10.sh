#!/bin/bash
#SBATCH --job-name=all-10            # Job name
#SBATCH --output=/fsx/ubuntu/users/dikhulla/cot-reasoning/jobs/abl_all_10_exp.out  # Stdout log
#SBATCH --error=/fsx/ubuntu/users/dikhulla/cot-reasoning/jobs/abl_all_10_exp.err   # Stderr log
...
# Run the script
echo "Running data_parallel_abliterated_all_10"
python -u /fsx/ubuntu/users/dikhulla/cot-reasoning/data_parallel_abliterated_all_10.py
