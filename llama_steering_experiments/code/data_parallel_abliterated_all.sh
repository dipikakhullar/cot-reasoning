#!/bin/bash
#SBATCH --job-name=abl-all            # Job name
#SBATCH --output=/fsx/ubuntu/users/dikhulla/cot-reasoning/jobs/abl_all_exp.out  # Stdout log
#SBATCH --error=/fsx/ubuntu/users/dikhulla/cot-reasoning/jobs/abl_all_exp.err   # Stderr log
...
# Run the script
echo "Running data_parallel_abliterated_all"
python /fsx/ubuntu/users/dikhulla/cot-reasoning/data_parallel_abliterated_all.py
